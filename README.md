...
- [[API Reference]]
- [Bug Tracking](/scottertucker1/graphlink/issues)
- [[Contributing]]
- [License](#license)
...
This will generate `graphlink.js` and `graphlink.min.js` in the `dist` directory
of the project.

# License

graphlink is licensed under the terms of the MIT License. See the [LICENSE](LICENSE) file for details.
